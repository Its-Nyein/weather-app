...
function Highlights({ stats }) {
  return (
    <div className="bg-slate-600 text-slate-200 p-2 flex flex-col justify-start items-center text-transform sclale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
